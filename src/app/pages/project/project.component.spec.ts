...
import { ProjectComponent, ProjectAddnewAditionalDialog, ProjectAddnewDialog, ProjectEditDialog } from './project.component';
...
describe('ProjectComponent', () => {
  ...
  let componentAddnew: ProjectAddnewDialog;
  let fixtureAddnew: ComponentFixture<ProjectAddnewDialog>;
  
  let componentEdit: ProjectEditDialog;
  let fixtureEdit: ComponentFixture<ProjectEditDialog>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ ProjectComponent, ProjectAddnewDialog, ProjectEditDialog ],
  ...
  beforeEach(() => {
    ...
    fixtureAddnew = TestBed.createComponent(ProjectAddnewDialog);
    componentAddnew = fixtureAddnew.componentInstance;
    componentAddnew.ngOnInit();
    //componentAddnew.submit('e');

    fixtureEdit = TestBed.createComponent(ProjectEditDialog);
